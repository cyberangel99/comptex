<?php
add_shortcode( 'kalkulate_fact_count', function($atts, $content = null){
...
if(class_exists('WPBakeryVisualComposerAbstract')){
	vc_map(array(
		'name'			=> esc_html__( 'kalkulat fact count', 'kalkulat' ),
		'base'			=> 'kalkulate_fact_count',
		'class'			=> '',
		'description'	=> esc_html__( 'add multiple counter', 'kalkulat' ),
