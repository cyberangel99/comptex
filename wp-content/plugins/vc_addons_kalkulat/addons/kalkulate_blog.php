...
add_shortcode( 'kalkulate_blog', function($atts, $content = null){
	...
	$output .='<div class="blog-style-two-section section-padding">
			...
			if($blog_query->have_posts()) : 
				...
				while($blog_query->have_posts()) : $blog_query->the_post();
					...
					$output.='<div class="'.(!empty($post_grid) ? $post_grid : 'col-md-4').' col-sm-6 col-xs-12">
	                    <div class="blog-item blog-style-two '.$is_animation.'" '.$animation_styles.'>
	                        <div class="image">
	                            <div class="date">
...
if(class_exists('WPBakeryVisualComposerAbstract')){
	vc_map(array(
		'name'			=> esc_html__( 'kalkulat blog', 'kalkulat' ),
		'base'			=> 'kalkulate_blog',
		'class'			=> '',
