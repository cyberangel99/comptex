...
add_shortcode( 'kalkulate_blog_two', function($atts, $content = null){
	...
	$output .='<div class="blog-section home1-blog-section">
			...
			if($blog_query->have_posts()) :
				...
				while($blog_query->have_posts()) : $blog_query->the_post();
					...
					$output.='<div class="'.(!empty($post_grid) ? $post_grid : 'col-md-4').' col-sm-6 col-xs-12">
	                    <div class="blog-item blog-style-one '.$is_animation.'" '.$animation_style.'>
	                        <div class="image">
	                        ...
	                        <div class="date">
	                            <a href="'.get_the_permalink().'">'.esc_html__( 'Read More', 'kalkulat' ).'</a>
	                        </div>
	                    </div>
	                </div>';
	                $i = $i+ 0.3;
...
if(class_exists('WPBakeryVisualComposerAbstract')){
	vc_map(array(
		'name'			=> esc_html__( 'kalkulat Blog Two', 'kalkulat' ),
		'base'			=> 'kalkulate_blog_two',
		'class'			=> '',
