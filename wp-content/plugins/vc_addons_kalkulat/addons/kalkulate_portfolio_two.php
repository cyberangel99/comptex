...
add_shortcode( 'kalkulate_protfolio_two', function($atts, $content = null){
	...
	$output = '';
		...
		if($query->have_posts()){
			$output .='<div class="home-two-gallery">
			    <div class="row">
			        <div class="col-md-12">';
...
if(class_exists('WPBakeryVisualComposerAbstract')){
	vc_map(array(
		'name'			=> esc_html__( 'kalkulat Protfolio two', 'kalkulat' ),
		'base'			=> 'kalkulate_protfolio_two',
		'class'			=> '',
		'description'	=> esc_html__( 'Add kalkulat Protfolio', 'kalkulat' ),
